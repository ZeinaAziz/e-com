...
@section('content')
   ...
   @if(session()->has('messege'))
       ...
       <h2 style="display:flex;align-items:center; justify-content:center; margin-bottom: 40px;">Product List</h2>
       <h2 style="display:flex;align-items:center; justify-content:center; margin-bottom: 40px;">All Products : {{count($products)}} </h2>
        <table class="container table table-striped " style="margin-right:40px">
            ...
            @foreach($products as $product)
                    ...
                    <td>
                        <a type="submit" href="{{route('products.edit',$product->id)}}" class="btn btn-light">Edit</a>
